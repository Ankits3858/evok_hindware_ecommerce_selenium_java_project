...
public class Dining_Page_Test005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Dining_Page_Finish_type_filter_test()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
      ...
      //  cu.scroll_down();
        ...
        cu.click_on_element(D.get_Dining_Finish_type_dropdown());
        logger.info("successfully clicked on the Dining Finish_type_ dropdown");
        logger.info("VERIFYING the checkboxes inside 'Dining Finish_type_ dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='finish_type']//child::input");
        logger.info("ALL checkboxes inside 'Dining Finish_type_ type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Dining Finish_type_ type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='finish_type']//child::input");
        logger.info("ALL checkboxes inside 'Dining Finish_type_ dropdown' are enabled");
