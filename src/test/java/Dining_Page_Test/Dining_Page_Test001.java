...
public class Dining_Page_Test001 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
   // @Test
    public void Dining_Page_Broken_links()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        //cu.scroll_down();
        cu.scroll_down_as_needed("window.scrollBy(0,100)"," ");
        //cu.move_to_element(D.get_Dining());
        cu.click_on_element(D.get_Dining());
        logger.info("successfully clicked on the Dining");
        cu.Broken_url();
        logger.info("no broken links found on Dining product page");
