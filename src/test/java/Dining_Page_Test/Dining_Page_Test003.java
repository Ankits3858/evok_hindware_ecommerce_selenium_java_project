...
public class Dining_Page_Test003 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Dining_Page_Category_filter_test()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       // cu.scroll_down();
        ...
        cu.click_on_element(D.get_Dining_category_dropdown());
        logger.info("successfully clicked on the Dining category dropdown");
        logger.info("VERIFYING the checkboxes inside 'Dining category dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='cat']//child::input");
        logger.info("ALL checkboxes inside 'Dining category type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Dining category type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='cat']//child::input");
        logger.info("ALL checkboxes inside 'Dining category dropdown' are enabled");
