...
public class Hindware_Page_Test011 extends Baseclass {
    public WebDriver driver;

    @Test(retryAnalyzer = My_Retry.class)
    public void Hindware_Page_Filter_Technology_Dropdown() {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.click_on_element(hw.get_Hindware_Filter_technology_dropdown());
        cu.scroll_down();
        logger.info("successfully clicked on the Hindware Filter_Technology dropdown");
        logger.info("VERIFYING the checkboxes inside 'Hindware Filter_Technology dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='filter_technology']//child::input");
        logger.info("ALL checkboxes inside 'Hindware Filter_Technology type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Hindware Filter_Technology type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='filter_technology']//child::input");
        logger.info("ALL checkboxes inside 'Hindware Filter_Technology dropdown' are enabled");
    }
