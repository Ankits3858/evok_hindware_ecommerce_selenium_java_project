...
public class Hindware_Page_Test004 extends Baseclass {
    public WebDriver driver;

    @Test(retryAnalyzer = My_Retry.class)
    public void Hindware_Page_Capacity_Dropdown() throws InterruptedException {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.click_on_element(hw.get_Hindware_Capacity_dropdown());
        logger.info("successfully clicked on the Hindware Capacity dropdown");
        logger.info("VERIFYING the checkboxes inside 'Hindware Capacity dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='capacity_lit']//child::input");
        logger.info("ALL checkboxes inside 'Hindware Capacity type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Hindware Capacity type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='capacity_lit']//child::input");
        logger.info("ALL checkboxes inside 'Hindware Capacity dropdown' are enabled");
