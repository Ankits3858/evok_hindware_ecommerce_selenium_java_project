...
public class Hindware_Page_Test014 extends Baseclass {
    public WebDriver driver;

    @Test(retryAnalyzer = My_Retry.class)
    public void Hindware_Page_Size_Dropdown() {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.click_on_element(hw.get_Hindware_Size_dropdown());
        cu.scroll_down();
        logger.info("successfully clicked on the Hindware Size dropdown");
        logger.info("VERIFYING the checkboxes inside 'Hindware Size dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='size']//child::input");
        logger.info("ALL checkboxes inside 'Hindware Size type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Hindware Size type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='size']//child::input");
        logger.info("ALL checkboxes inside 'Hindware Size dropdown' are enabled");
    }
