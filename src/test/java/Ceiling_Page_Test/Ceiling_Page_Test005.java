...
public class Ceiling_Page_Test005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void ceiling_Page_Test_primary_material_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on ceiling menu");
        cu.scroll_down();
        ...
        extent.getTest().log(Status.INFO,"ceiling menu primary filter dropdown menu options are enabled and displayed");
