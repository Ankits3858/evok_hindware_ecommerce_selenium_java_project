...
public class Ceiling_Page_Test004 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void ceiling_Page_Test_color_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on color dropdown of ceiling menu page ");
        cu.scroll_down();
