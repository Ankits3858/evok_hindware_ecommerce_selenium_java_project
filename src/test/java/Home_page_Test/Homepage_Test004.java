...
public class Homepage_Test004 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    //Testing the broken links inside "7 Things to Consider Before Buying a Sofa" Read more.
    public void Homepage_Broken_links_Read_More1_page() throws InterruptedException {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       // cu.move_to_element(h.get_read_more1());
        cu.scroll_down();
        cu.scroll_down();

        cu.click_on_element(h.get_read_more1());
