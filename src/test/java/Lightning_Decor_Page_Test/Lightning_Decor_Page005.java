...
public class Lightning_Decor_Page005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Lightning_Decor_Page_custom_dropwdown()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.click_on_element(ld.get_Lightning_Decor_Custom_product_dropdown());
        logger.info("successfully clicked on the Lightning_Decor_Page custom_product dropdown");
        logger.info("VERIFYING the checkboxes inside 'Lightning_Decor_Page custom_product dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='gf_custom_product']//child::input");
        logger.info("ALL checkboxes inside 'Lightning_Decor_Page custom_product type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Lightning_Decor_Page custom_product type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='gf_custom_product']//child::input");
        logger.info("ALL checkboxes inside 'Lightning_Decor_Page custom_product dropdown' are enabled");
