...
public class Lightning_Decor_Page002 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Lightning_Decor_Page_Test_Broken_images()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.Broken_image();
        logger.info("no broken images found on Lightning_Decor product page");
