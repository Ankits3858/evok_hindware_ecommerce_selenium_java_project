...
public class Lightning_Decor_Page001 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Lightning_Decor_Page_Test_Broken_links()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.Broken_url();
        logger.info("no broken links found on Lightning_Decor product page");
