...
public class Wall_Clock_Page_Test004 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void wall_clock_Page_Test_color_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on color dropdown of wall_clock menu page ");
        cu.scroll_down();
        ...
        extent.getTest().log(Status.INFO,"color dropdown menu options are displayed,enabled and clickable");
