...
public class Wall_Clock_Page_Test005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void wall_clock_Page_Test_primary_material_dropdown()
    {
        ...
        cu.scroll_down();
        cu.scroll_down();
        cu.click_on_element(hp.get_wall_clock());
        extent.getTest().log(Status.INFO,"successfully clicked on wall_clock menu");
        cu.scroll_down();
        ...
        extent.getTest().log(Status.INFO,"wall_clock menu primary filter dropdown menu options are enabled and displayed");
