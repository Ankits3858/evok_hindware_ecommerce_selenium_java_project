...
public class Wall_Clock_Page_Test002 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    // @Test
    public void wall_clock_Broken_images()
    {
        ...
        logger.info("successfully clicked on the wall_clock menu");
        extent.getTest().log(Status.INFO,"successfully clicked on the wall_clock");
        cu.Broken_url();
        logger.info("no broken images found on wall_clock product page");
