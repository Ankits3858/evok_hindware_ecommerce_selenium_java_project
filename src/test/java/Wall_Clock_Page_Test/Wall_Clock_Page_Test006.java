...
public class Wall_Clock_Page_Test006 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Photo_Frames_Page_Test_sort_By_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on wall_clock page sort by menu");
        cu.scroll_down();
        cu.are_checkboxes_enabled("(//select[@id='sorter'])[1]//child::option");
        cu.are_checkboxes_dispalyed("(//select[@id='sorter'])[1]//child::option");
        extent.getTest().log(Status.INFO,"sort by menu options are enabled,clickable and displayed");
