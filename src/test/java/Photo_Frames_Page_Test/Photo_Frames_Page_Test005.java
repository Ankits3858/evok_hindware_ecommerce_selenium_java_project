package Photo_Frames_Page_Test;
...
public class Photo_Frames_Page_Test005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Photo_Frames_Page_Test_Brands_dropdown()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.scroll_down();
        cu.scroll_down();
        cu.click_on_element(hp.get_photo_frames());
        cu.scroll_down();
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='price']//child::input");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='price']//child::input");
