...
public class Sofa_Page_Test004 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Sofa_Page_color_Dropdown_test()
    {
       ...
       // cu.scroll_down();
        ...
        cu.click_on_element(sp.get_Sofas_color_dropdown());
        logger.info("successfully clicked on the Sofas color dropdown");
        logger.info("VERIFYING the checkboxes inside 'Sofas color dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='color']//child::input");
        logger.info("all checkboxes inside 'Sofas color type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Sofas color type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='color']//child::input");
        logger.info("ALL checkboxes inside 'sofa color dropdown' are enabled");
    ...
    public void closure(ITestResult result) throws IOException {
        ...
        logger.info("E2E journey of 'Scooter' is working fine");
