...
public class Accesories_Decor_Page_Test004 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Accesories_Decor_Page_color()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.click_on_element(ad.get_Accessories_Decor_color_dropdown());
        logger.info("successfully clicked on the Accessories_Page color dropdown");
        logger.info("VERIFYING the checkboxes inside 'Accessories_Page color dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='color']//child::input");
        logger.info("ALL checkboxes inside 'Accessories_Page color type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Accessories_Page color type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='color']//child::input");
        logger.info("ALL checkboxes inside 'Accessories_Page color dropdown' are enabled");
