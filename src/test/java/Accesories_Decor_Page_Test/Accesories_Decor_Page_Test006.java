...
public class Accesories_Decor_Page_Test006 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Accesories_Decor_Page_Test_Broken_images()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.scroll_down();
        cu.click_on_element(ad.get_Accessories_Decor_sort_by_dropdown());
        logger.info("successfully clicked on the Accessories_Page sort_by dropdown");
        logger.info("VERIFYING the checkboxes inside 'Accessories_Page sort_by dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("(//select[@id='sorter'])[1]//child::option");
        logger.info("ALL checkboxes inside 'Accessories_Page sort_by type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Accessories_Page sort_by type dropdown' enabled or not");
        cu.are_checkboxes_enabled("(//select[@id='sorter'])[1]//child::option");
        logger.info("ALL checkboxes inside 'Accessories_Page sort_by dropdown' are enabled");
