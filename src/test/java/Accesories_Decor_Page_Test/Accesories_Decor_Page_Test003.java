package Accesories_Decor_Page_Test;

import PageObjects.Accessories_Decor_Page;
...
public class Accesories_Decor_Page_Test003 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
   // @Test
    public void Accesories_Decor_Page_Category_Dropdown()
    {
        LoginPage lp = new LoginPage(driver);
        Actions actions = new Actions(driver);
        CommonUtilities cu = new CommonUtilities(driver);
        Accessories_Decor_Page ad = new Accessories_Decor_Page(driver);
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.click_on_element(ad.get_Accessories_Decor());
        logger.info("successfully clicked on the Accesories_Decor");
        extent.getTest().log(Status.INFO,"successfully clicked on the Accesories_Decor");
        cu.click_on_element(ad.get_Accessories_Decor_category_dropdown());
        logger.info("successfully clicked on the Accessories_Page category dropdown");
        extent.getTest().log(Status.INFO,"successfully clicked on the Accessories_Page category dropdown");
        logger.info("VERIFYING the checkboxes inside 'Accessories_Page category dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='cat']//child::input");
        logger.info("ALL checkboxes inside 'Accessories_Page category type dropdown' are displayed");
        extent.getTest().log(Status.INFO,"ALL checkboxes inside 'Accessories_Page category type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Accessories_Page category type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='cat']//child::input");
        logger.info("ALL checkboxes inside 'Accessories_Page category dropdown' are enabled");
        extent.getTest().log(Status.INFO,"ALL checkboxes inside 'Accessories_Page category dropdown' are enabled");
    ...
    public void closure(ITestResult result) throws IOException {
        ...
        extent.getTest().log(Status.INFO,"Accessories Decor page category dropdown working fine");
