...
public class Accesories_Decor_Page_Test005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Accesories_Decor_Page_primary_material_dropdown()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.scroll_down();
        cu.click_on_element(ad.get_Accessories_Decor_primary_material_dropdown());
        logger.info("successfully clicked on the Accessories_Page primary_material dropdown");
        logger.info("VERIFYING the checkboxes inside 'Accessories_Page primary_material dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='primary_material']//child::input");
        logger.info("ALL checkboxes inside 'Accessories_Page primary_material type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Accessories_Page primary_material type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='primary_material']//child::input");
        logger.info("ALL checkboxes inside 'Accessories_Page primary_material dropdown' are enabled");
