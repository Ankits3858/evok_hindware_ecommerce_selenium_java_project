...
public class Login_Test002 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void editboxes_and_buttons()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully clicked to Sign in");
        ...
        cu.is_clickable(lp.getEmail());
        logger.info("email field is clickable");
        cu.is_displayed(lp.getEmail());
        logger.info("email field is displayed");
        cu.is_enabled(lp.getEmail());
        ...
        cu.is_clickable(lp.getPassword());
        logger.info("password field is clickable");
        cu.is_displayed(lp.getPassword());
        logger.info("password field is displayed");
        cu.is_enabled(lp.getPassword());
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.is_clickable(lp.getForgot_password());
        logger.info("forgot password link is clickable");
        cu.is_enabled(lp.getForgot_password());
        logger.info("forgot password link is enabled");
        cu.is_displayed(lp.getForgot_password());
        logger.info("forgot password link is displayed");


        cu.is_clickable(lp.get_new_user_register());
        logger.info("new_user_register link is clickable");
        cu.is_enabled(lp.get_new_user_register());
        logger.info("new_user_register is link enabled");
        cu.is_displayed(lp.get_new_user_register());
        logger.info("new_user_register is link displayed");


        cu.is_clickable(lp.getLoginButton());
        logger.info("login button is clickable");
        cu.is_displayed(lp.getLoginButton());
        logger.info("login button is displayed");
        cu.is_enabled(lp.getLoginButton());
        ...
        logger.info("successfully landed to homepage and account confirmed successfully");
