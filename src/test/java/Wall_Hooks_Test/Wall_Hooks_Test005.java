...
public class Wall_Hooks_Test005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void wall_hooks_Page_Test_primary_material_dropdown()
    {
        ...
        cu.scroll_down();
        cu.scroll_down();
        cu.click_on_element(hp.get_wall_hooks());
        extent.getTest().log(Status.INFO,"successfully clicked on wall_hooks menu");
        cu.scroll_down();
        ...
        extent.getTest().log(Status.INFO,"wall_hooks menu primary filter dropdown menu options are enabled and displayed");
    }
    @BeforeMethod
