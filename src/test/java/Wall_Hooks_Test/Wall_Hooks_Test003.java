...
public class Wall_Hooks_Test003 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void wall_hooks_Page_Test_brands_dropdown() {
        ...
        //cu.scroll_down();
        //cu.move_to_element(hp.get_wall_hooks());
        cu.click_on_element(hp.get_wall_hooks());
        logger.info("successfully clicked on wall_hooks menu");
