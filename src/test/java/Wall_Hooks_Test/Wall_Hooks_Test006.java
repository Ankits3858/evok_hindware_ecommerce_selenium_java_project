...
public class Wall_Hooks_Test006 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void wall_hooks_Page_Test_sort_By_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on wall_hooks page sort by menu");
        cu.scroll_down();
