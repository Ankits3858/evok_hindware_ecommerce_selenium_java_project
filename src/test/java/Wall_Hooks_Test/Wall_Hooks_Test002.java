...
public class Wall_Hooks_Test002 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    // @Test
    public void wall_hooks_Broken_images()
    {
        ...
        logger.info("successfully clicked on the wall_hooks menu");
        extent.getTest().log(Status.INFO,"successfully clicked on the wall_hooks");
        cu.Broken_url();
        logger.info("no broken images found on wall_hooks product page");
