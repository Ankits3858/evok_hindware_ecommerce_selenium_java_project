...
public class Wall_Hooks_Test004 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void wall_hooks_Page_Test_color_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on color dropdown of wall_hooks menu page ");
        cu.scroll_down();
