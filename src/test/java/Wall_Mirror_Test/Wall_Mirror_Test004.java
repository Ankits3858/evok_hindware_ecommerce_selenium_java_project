...
public class Wall_Mirror_Test004 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void wall_mirror_Page_Test_color_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on color dropdown of wall_mirror menu page ");
        cu.scroll_down();
