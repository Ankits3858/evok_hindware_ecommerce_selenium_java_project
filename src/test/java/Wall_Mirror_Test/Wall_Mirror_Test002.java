...
public class Wall_Mirror_Test002 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    // @Test
    public void wall_mirror_Broken_images()
    {
        ...
        logger.info("successfully clicked on the wall_mirror menu");
        extent.getTest().log(Status.INFO,"successfully clicked on the wall_mirror");
        cu.Broken_url();
        logger.info("no broken images found on wall_mirror product page");
