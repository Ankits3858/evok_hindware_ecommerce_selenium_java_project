...
public class Wall_Mirror_Test005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void wall_mirror_Page_Test_primary_material_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"wall_mirror menu primary filter dropdown menu options are enabled and displayed");
    }
    @BeforeMethod
