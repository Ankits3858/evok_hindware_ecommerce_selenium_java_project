...
public class Wall_Mirror_Test006 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void wall_mirror_Page_Test_sort_By_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on wall_mirror page sort by menu");
        cu.scroll_down();
