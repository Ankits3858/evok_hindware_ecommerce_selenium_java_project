...
public class Wall_Decor_Page_Test001 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Wall_Decor_Page_Test_Broken_links()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       // cu.scroll_down();
        ...
        cu.Broken_url();
        logger.info("no broken links found on Wall_Decor product page");
