...
public class Wall_Decor_Page_Test005 extends Baseclass {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       // cu.scroll_down();
        ...
        cu.click_on_element(wd.get_Wall_Decor_primary_material_dropdown());
        logger.info("successfully clicked on the Wall_Decor_Page primary_material dropdown");
        logger.info("VERIFYING the checkboxes inside 'Wall_Decor_Page primary_material dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='primary_material']//child::input");
        logger.info("ALL checkboxes inside 'Wall_Decor_Page primary_material type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Wall_Decor_Page primary_material type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='primary_material']//child::input");
        logger.info("ALL checkboxes inside 'Wall_Decor_Page primary_material dropdown' are enabled");
