...
public class Wall_Decor_Page_Test006 extends Baseclass {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
      ...
      //  cu.scroll_down();
        ...
        cu.click_on_element(wd.get_Wall_Decor_sort_by_dropdown());
        logger.info("successfully clicked on the Wall_Decor_Page sort_by dropdown");
        logger.info("VERIFYING the checkboxes inside 'Wall_Decor_Page sort_by dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("(//select[@id='sorter'])[1]//child::option");
        logger.info("ALL checkboxes inside 'Wall_Decor_Page sort_by type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Wall_Decor_Page sort_by type dropdown' enabled or not");
        cu.are_checkboxes_enabled("(//select[@id='sorter'])[1]//child::option");
        logger.info("ALL checkboxes inside 'Wall_Decor_Page sort_by dropdown' are enabled");
