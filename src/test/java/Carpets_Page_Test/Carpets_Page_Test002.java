...
public class Carpets_Page_Test002 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    // @Test
    public void carpets_Broken_Images()
    {
        ...
        logger.info("successfully clicked on the carpets menu");
        extent.getTest().log(Status.INFO,"successfully clicked on the carpets");
        cu.Broken_image();
        logger.info("no broken images found on carpets product page");
    }
    @BeforeMethod
