...
public class Carpets_Page_Test006 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void carpets_Page_Test_sort_By_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on carpets page sort by menu");
        cu.scroll_down();
       // cu.scroll_down();
