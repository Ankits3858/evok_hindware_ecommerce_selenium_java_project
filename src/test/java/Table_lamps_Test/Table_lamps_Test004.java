...
public class Table_lamps_Test004 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void table_lamps_Page_Test_color_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on color dropdown of table_lamps menu page ");
        cu.scroll_down();
