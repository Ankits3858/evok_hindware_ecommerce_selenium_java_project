...
public class Table_lamps_Test005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void table_lamps_Page_Test_primary_material_dropdown()
    {
        ...
        cu.scroll_down();
        cu.scroll_down();
        cu.click_on_element(hp.get_table_lamps());
        extent.getTest().log(Status.INFO,"successfully clicked on table_lamps menu");
        cu.scroll_down();
        ...
        extent.getTest().log(Status.INFO,"table_lamps menu primary filter dropdown menu options are enabled and displayed");
    }
    @BeforeMethod
