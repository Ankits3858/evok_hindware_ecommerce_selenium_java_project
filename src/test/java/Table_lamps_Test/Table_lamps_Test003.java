...
public class Table_lamps_Test003 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void table_lamps_Page_Test_brands_dropdown() {
        ...
        //cu.scroll_down();
        //cu.move_to_element(hp.get_table_lamps());
        cu.click_on_element(hp.get_table_lamps());
        logger.info("successfully clicked on table_lamps menu");
