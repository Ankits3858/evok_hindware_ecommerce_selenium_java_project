...
public class Table_lamps_Test006 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void table_lamps_Page_Test_sort_By_dropdown()
    {
        ...
        extent.getTest().log(Status.INFO,"successfully clicked on table_lamps page sort by menu");
        cu.scroll_down();
