...
public class Table_lamps_Test002 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    // @Test
    public void table_lamps_Broken_images()
    {
        ...
        logger.info("successfully clicked on the table_lamps menu");
        extent.getTest().log(Status.INFO,"successfully clicked on the table_lamps");
        cu.Broken_url();
        logger.info("no broken images found on table_lamps product page");
