...
public class Living_Room_Page_Test005 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Finish_type_filter_checkboxes_test()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.scroll_down();
        cu.click_on_element(lr.get_finish_type());
        logger.info("successfully clicked on finish type filter");
        ...
        logger.info("all the checkboxes of finish type filter are displayed");
