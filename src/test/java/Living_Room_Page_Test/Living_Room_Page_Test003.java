...
public class Living_Room_Page_Test003 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Category_Filter_checkboxes_Test()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.scroll_down();
        cu.click_on_element(lr.get_category_filter());
        logger.info("successfully clicked on category filter");
        ...
        logger.info("category filter closed successfully");
        logger.info("checkboxes inside category enabled and displayed successfully");
