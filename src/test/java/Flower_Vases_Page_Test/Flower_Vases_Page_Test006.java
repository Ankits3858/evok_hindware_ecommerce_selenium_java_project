package Flower_Vases_Page_Test;
...
public class Flower_Vases_Page_Test006 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Flower_Vases_Page_Test_sort_By_dropdown()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.scroll_down();
        cu.scroll_down();
        cu.click_on_element(hp.get_flower_vases());
        cu.scroll_down();
