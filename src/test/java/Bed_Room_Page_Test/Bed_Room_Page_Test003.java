...
public class Bed_Room_Page_Test003 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Bed_Room_Page_category_dropdown_Test() {
       ...
       logger.info("Successfully entered inside password field");
        ...
        cu.scroll_down();
        cu.click_on_element(bp.get_Bed_Room_category_dropdown());
        logger.info("successfully clicked on the Bed_Room category dropdown");
        logger.info("VERIFYING the checkboxes inside 'Bed_Room category dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='cat']//child::input");
        logger.info("ALL checkboxes inside 'Bed_Room category type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Bed_Room category type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='cat']//child::input");
        logger.info("ALL checkboxes inside 'Bedroom category dropdown' are enabled");
