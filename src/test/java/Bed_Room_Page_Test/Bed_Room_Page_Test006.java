...
public class Bed_Room_Page_Test006 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Bed_Room_page_Primary_material_filter_test()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       // cu.scroll_down();
        ...
        cu.click_on_element(bp.get_Bed_Room_primary_material_dropdown());
        logger.info("successfully clicked on the Bed_Room Primary material dropdown");
        logger.info("VERIFYING the checkboxes inside 'Bed_Room Primary material dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("//div[@data-role='ln_collapsible' and @attribute='primary_material']//child::input");
        logger.info("all checkboxes inside 'Bed_Room Primary material type dropdown' are displayed");
        logger.info("VERIFYING the checkboxes inside 'Bed_Room Primary material type dropdown' enabled or not");
        cu.are_checkboxes_enabled("//div[@data-role='ln_collapsible' and @attribute='primary_material']//child::input");
        logger.info("ALL checkboxes inside 'Bed_Room Primary material dropdown' are enabled");
    }
    @BeforeMethod
