...
public class Bed_Room_Page_Test007 extends Baseclass {
    public WebDriver driver;
    @Test(retryAnalyzer = My_Retry.class)
    public void Bed_Room_page_Sort_by_filter()
    {
...
extent.getTest().log(Status.INFO,"successfully landed to the homepage");
       ...
       // cu.scroll_down();
        ...
        cu.click_on_element(bp.get_Bed_Room_sort_by_dropdown());
        logger.info("successfully clicked on the Bed_Room Sort By dropdown");
        logger.info("VERIFYING the Options inside 'Bed_Room Sort By dropdown' are displayed or not");
        cu.are_checkboxes_dispalyed("(//select[@id='sorter'])[1]//child::option");
        logger.info("all Options inside 'Bed_Room Sort By type dropdown' are displayed");
        logger.info("VERIFYING the Options inside 'Bed_Room Sort By type dropdown' enabled or not");
        cu.are_checkboxes_enabled("(//select[@id='sorter'])[1]//child::option");
        logger.info("ALL Options inside 'Bed_Room Sort By dropdown' are enabled");
